...
--
DROP TABLE IF EXISTS COUNTRY_REGIONS_CITY;
...
--
-- Описание для таблицы galary_files
--
DROP TABLE IF EXISTS galary_files;
...
--
-- Описание для таблицы galary_list
--
DROP TABLE IF EXISTS galary_list;
...
--
DROP TABLE IF EXISTS USERS_FRIENDS_IN_GROUPS;
...
-- 
-- Вывод данных для таблицы COUNTRY_REGIONS
--
...
-- 
-- Вывод данных для таблицы COUNTRY_REGIONS_CITY
--
INSERT INTO COUNTRY_REGIONS_CITY VALUES 
...
-- 
-- Вывод данных для таблицы galary_files
--
INSERT INTO galary_files VALUES 
  (1, '/photos/decline666@bk.ru/galary/1.png', '/photos/decline666@bk.ru/galary/1.png', 'textys', 1, 0, '2010-09-23 18:58:53', 'muComment', 1, 1, 'nonameproduct', 'nocontent', '$7000'),
  (2, '/photos/decline666@bk.ru/galary/4.jpg', '/photos/decline666@bk.ru/galary/4.jpg', 'sdgwerg', 2, 0, '2010-09-23 18:59:30', 'noooo', 1, NULL, 'rrr', NULL, NULL),
  (3, '/photos/decline666@bk.ru/galary/5.jpg', '/photos/decline666@bk.ru/galary/5.jpg', 'wert54', 3, 0, '2010-09-23 18:59:46', NULL, 1, NULL, NULL, NULL, NULL),
  (4, '/photos/decline666@bk.ru/galary/3.jpg', '/photos/decline666@bk.ru/galary/3.jpg', NULL, 4, 0, '2010-09-25 16:59:20', NULL, 1, NULL, NULL, NULL, NULL),
  (5, '/photos/decline666@bk.ru/galary/20090330170938.jpg', '/photos/decline666@bk.ru/galary/20090330170938.jpg', NULL, 5, 0, '2010-09-25 17:00:08', NULL, 1, NULL, NULL, NULL, NULL);

-- 
-- Вывод данных для таблицы galary_list
--
INSERT INTO galary_list VALUES 
  (1, 13, 'РџРµСЂРІС‹Р№ Р°Р»СЊР±РѕРј', NULL, 'РєРѕРјРјРµРЅС‚Р°СЂРёР№ Р°РІС‚РѕСЂР° Рє Р°Р»СЊР±РѕРјСѓ', '2010-08-21 00:00:00', NULL, '125;127;', '1', '125;', 1, ''),
  (2, 127, 'Р°Р»СЊР±РѕРј РІС‚РѕСЂРѕРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ', NULL, NULL, '2010-08-21 00:00:00', NULL, '', NULL, NULL, 1, ''),
  (3, 125, 'РїРµСЂРІС‹Р№ Р°Р»СЊР±РѕРј С‚СЂРµС‚СЊРµРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ', NULL, 'РєРѕРјРјРµРЅС‚Р°СЂРёР№', '2010-08-21 00:00:00', NULL, '123;', NULL, NULL, 1, ''),
  (4, 13, 'Р’С‚РѕСЂРѕР№ Р°Р»СЊР±РѕРј СЋР·РµСЂР° 123', NULL, NULL, '2010-09-19 00:00:00', NULL, '', '2', NULL, 2, '');
...
INSERT INTO Modules VALUES 
  (1, 'Текстовый модуль', '', 'text'),
  (2, 'Пользователи', 'Управляет входом пользователя на сайт и афторизация', 'user'),
  (3, 'Модуль вывода ошибок страницы', 'Выводит ошибку 404 и другие виды ошибок', 'error'),
  (4, 'Друзья пользователя', 'Выводит информацию о друзьях пользователя. Управление пользователями и группами: добавление/удалние, назначение группы.\r\nЗависит от модуля Пользователи.', 'friends'),
  (5, 'Галерея', 'Галерея пользователей', 'galary');

-- 
-- Вывод данных для таблицы REGISTRY
--
INSERT INTO REGISTRY VALUES 
  ('USERS_NO_PHOTO', 's:20:"/photos/no-photo.jpg";');

-- 
-- Вывод данных для таблицы SITE_USERS
--
INSERT INTO SITE_USERS VALUES 
  (1, 'tym_s@mail.ru', '4039c580a8cd2a634c73587a2f84a8b6', 673923492, '2010-09-16', 'Артём', 'Солопий', 0, '1989-07-21', 'photo.png', NULL, NULL, NULL, 'Солнечный Бульвар, д.6', 3, 1, 0, 256),
  (9, 'ttf@laser.ru', 'bf6642f6f82aa8bb48e66353b709f107', 0, '2010-09-19', 'Максим', 'Огурцов', 0, '1988-01-15', '', NULL, NULL, NULL, '', 1, 1, 0, 256),
  (12, 'irina@take.me', 'fc5e038d38a57032085441e7fe7010b0', 0, '2010-09-22', 'Ирина', 'Фёдорова', 1, '1980-01-01', '', NULL, NULL, NULL, '', 0, 0, 0, 256),
  (13, 'decline666@bk.ru', '25f9e794323b453885f5181f1b624d0b', 0, '2010-09-22', 'Timur', 'Timur', 0, '1988-12-29', '', NULL, NULL, NULL, '', 0, 1, 0, 256),
  (14, 'Aik2029@gmail.com', '5f4dcc3b5aa765d61d8327deb882cf99', 0, '2010-09-23', 'Айдар', 'Фоатович', 0, '1988-03-17', '', NULL, NULL, NULL, '', 0, 1, 0, 256),
  (15, 'aik2029@gmail.ru', 'fcea920f7412b5da7be0cf42b8c93759', 0, '2010-09-28', 'Aidar', 'Shagiahmetov', 0, '1988-03-17', '', NULL, NULL, NULL, '', 0, 1, 1, 256),
  (16, 'entityfx@qip.ru', '4e1ec27aa116402174b71d7ec16a6dcb', 0, '2010-09-30', 'Артём', 'Солопий', 0, '1989-07-21', NULL, NULL, NULL, NULL, NULL, 0, 1, 0, 1283);

-- 
-- Вывод данных для таблицы TEXT_MODULE
--
...
INSERT INTO URL VALUES 
  (1, '/', 'Главная', '', 1, 0, 0, 0),
  (2, 'fruit', 'Фрукты', '', 1, 0, 1, 0),
  (3, 'apple', 'Яблоко', '', 1, 0, 2, 1),
  (4, 'clouth', 'Одежда', '', 1, 1, 1, 0),
  (5, 'cherry', 'Вишня', 'Красная вишня', 1, 1, 2, 0),
  (6, 'sweeter', 'Свитер', '', 1, 0, 4, 0),
  (7, 'boots', 'Ботинки', '', 1, 1, 4, 0),
  (8, 'summer', 'Летние', '', 1, 0, 7, 0),
  (9, 'winter', 'Зимние', '', 1, 1, 7, 0),
  (10, 'user', 'Вход на сайт', 'Вход на сайт', 2, 2, 1, 1),
  (11, 'error', 'Ошибки', 'Ошибки', 1, 0, 1, 0),
  (12, '404', 'Ошибка 404', 'Ошибка 404', 3, 0, 11, 0),
  (13, 'friends', 'Друзья', 'Мои друзья', 4, 3, 1, 1),
  (14, 'galary', 'galary', '', 5, 0, 1, 1);

-- 
-- Вывод данных для таблицы USERS_FRIENDS_IN_GROUPS
--
INSERT INTO USERS_FRIENDS_IN_GROUPS VALUES 
  (54, 9, '10'),
  (52, 1, '22'),
  (49, 14, '10'),
  (50, 1, '4');
...
-- 
-- Вывод данных для таблицы USERS_FRIENDSHIP
--
INSERT INTO USERS_FRIENDSHIP VALUES 
  (7, 1, '9'),
  (10, 9, '1'),
  (8, 1, '14'),
  (5, 1, '13'),
...
--
-- Описание для триггера BEFORE_DELETE_USERS_GROUPS
--
DROP TRIGGER IF EXISTS BEFORE_DELETE_USERS_GROUPS$$
CREATE
DEFINER = 'root'@'localhost'
TRIGGER BEFORE_DELETE_USERS_GROUPS
BEFORE DELETE
ON USERS_GROUPS
FOR EACH ROW
BEGIN
  DELETE
  FROM
    `USERS_FRIENDS_IN_GROUPS`
  WHERE
    USERS_FRIENDS_IN_GROUPS.group_id = OLD.group_id;
END
$$
